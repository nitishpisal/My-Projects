        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <form name="register" id="register" method="post" action="<%=request.getContextPath()%>/registerUserDetails">
                       ...
                       <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                               <!--  <label>University</label>        -->          
                      			<input type="text" class="form-control" placeholder="You are.." disabled>            
                              
                                <select class="form-control" name = "doi" style="width: 300px;">
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                            <input type="text" class="form-control" placeholder="Address " id="address" disabled>
                                <label>Street</label>
                        ...
                        <input type="hidden" name="confirmPass" value="${confirmPass2}">

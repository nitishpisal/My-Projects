...
<body>
    ...
    <div class="container">
		<div class="signInFormHolder"> 
   			<div class="signInForm">
		        ...
		        <div class="title">Sign In</div>
		                <form name = 'loginform' method='post' action='validate' id='form-control'>
		                   <ul> <li><input type='text' name='username' id='uName' placeholder='User Name'></li>
		                    ...
		                    <button class='btn' id='btn1' type='submit' ><b>Sign In</button><hr> >>Register Now
		                    <button class='btn' id='btn2' type='button' onclick="location.href='signup.jsp';" ><b>Register</button>	                    
		                    </li></ul>
     	 	...
     	 	<div class="register" >
    			<a href="http:/cssjunyard.com">Dont Have an account ? Register Now </a>
    		</div>
      	</div>
    </div>
    <!-- /.container -->

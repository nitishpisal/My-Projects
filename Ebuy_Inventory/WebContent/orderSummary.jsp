		...
		<div class="signInFormHolder"> 
   			<div class="signInForm">
		        ...
		        <div class="title">Order Summary</div>
		       			<form name = 'loginform' method='post' action='http://localhost:8080/Ebuy_Inventory/login.jsp' id='form-control'>
		       				<ul>
		                    ...
		                    <input type="hidden" value="<% session.removeAttribute("backHome");%>">
		                    <% if (request.getAttribute("quantityNo").equals("no")) {%>
		                    <li><font color="green"> Sorry, the selected quantity is not available </font></li>
		                    <button class='btn' id='btn1' type='button' onclick="location.href='http://localhost:4000/'"><b> Home </button><hr>
		                    <%} else { %>

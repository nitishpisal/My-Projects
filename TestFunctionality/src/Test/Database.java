...
public class Database {
	...
	protected String getSuggestedJobs(String condition){
		String jobs = "";
		query = "select j.title, j.pay from jobs j, categories c where (j.description like " + condition 
				+ " or j.title like "  + condition + " or c.categoryname like " + condition + ") and j.categoryid = c.categoryid";
